    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                            ...
                            <li class="nav-item">
                                <a href="{{ route('dashboard.Dashboard') }}"
                                    ...
                                    <img src="assets/dashboard icon.png" alt="image" class="img-fluid me-2"
                                        width="20">
            ...
            <div class="col d-flex flex-column flex-nowrap p-4">
                ...
                <div class="mt-3">
                    <h2 class="fw-bold" style="color: #191757;">Dashboard</h2>
                    <p class="text-muted">Admin / Dashboard</p>
                </div>
                <div class="row d-flex justify-content-center gap-4">
                    <div class="col-3 rounded-4"
                        style="background: #CEE7FE; border-left: 16px solid #191757; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
                        <div class="py-5 px-3">
                            <h3 class="fw-bold m-0">Total Interview</h3>
                            <p class="m-0">Total interview yang ada</p>
                        </div>
                    </div>
                    <div class="col-4 d-flex align-items-center rounded-4"
                        style="background: #CEE7FE; border-left: 16px solid #191757; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
                        <div class="px-3 d-flex justify-content-around align-items-center w-100">
                            <div>
                                <h3 class="fw-bold m-0">Interview</h3>
                                <p class="m-0">belum interview</p>
                            </div>
                            <div>
                                <img src="assets/pencil.png" alt="image" class="img-fluid" width="70">
                            </div>
                        </div>
                    </div>
                    <div class="col-4 d-flex align-items-center rounded-4"
