...
<body>
                    ...
                    <div class="col-md-6 px-5">
                        <div class="row d-flex flex-column my-5">
                            <div class="border border-1 rounded-5 shadow-lg py-5 px-5 mb-5">
                                ...
                                <form class="form-default" method="post" action="{{ route('loginlorem.auth2') }}">
                                    @csrf
                                    <div class="row text-center">
                                        <input type="email" id="email" name="email" placeholder="Enter email"
                                            class="form-control border border-2 rounded-4 px-4 py-3 mb-2 w-100"
                                            required>
                                        ...
                                        <input type="submit" value="Continue"
                                            class="text-white border rounded-4 px-5 py-3 w-100"
                                            style="background: #1FCC26;">
                                ...
                                <div class="row">
                                    <a href="{{ route('login.google.login') }}"
                                        class="border border-2 rounded-4 py-2 fw-bold text-center text-dark text-decoration-none mb-2 w-100"><img
                                            src="assets/logo google 1.png" alt="image"
                                            class="img-fluid me-3">Continue with
                                        Google</a>
                                    <a href="#"
                                        class="border border-2 rounded-4 py-2 fw-bold text-center text-dark text-decoration-none mb-2 w-100"><img
                                            src="assets/Microsoft 1.png" alt="image" class="img-fluid me-3">Continue
                                        with
                                        Google</a>
                                    <a href="#"
                                        class="border border-2 rounded-4 py-2 fw-bold text-center text-dark text-decoration-none mb-2 w-100"><img
                                            src="assets/Apple Logo.png" alt="image" class="img-fluid me-3">Continue
                                        with
                                        Google</a>
                                    <a href="#"
                                ...
                                <div class="row text-center">
                                    <p>Can't log in? . <a href="{{ route('daftar') }}"
        ...
        document.querySelector('.form-default').addEventListener('submit', function(event) {
            ...
            window.location.href = "{{ route('dashboard2.Dashboard') }}";
        });
    </script> --}}
</body>
