        ...
        <div class="col d-flex flex-column flex-nowrap p-4">
            ...
            <form action="{{ url('simpanDaftarInterview') }}" method="POST">
                ...
                <div class="row mb-1 m-0">
                    ...
                    <input type="text" name="durasi_zoom" placeholder="Durasi zoom"
                        class="col-6 border border-2 rounded-3 py-3" required>
                </div>

                <div class="row mt-3 mb-1 m-0">
                    <input type="text" name="link_zoom" placeholder="Masukkan link zoom"
                        class="col-6 border border-2 rounded-3 py-3" required>
                </div>
                ...
                <div class="row m-0 p-0 mt-3">
                    ...
                    <form action="{{ url('jadwal_interview.edit') }}" method="POST">
                        @csrf
